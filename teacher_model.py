"""
Code adapted from https://huggingface.co/Hate-speech-CNERG/bert-base-uncased-hatexplain-rationale-two/tree/main
"""
...
#         embed = torch.cat((mean_pooling, max_pooling), 1)
        ...
        if labels is not None:
            ...
            if loss_total is not None:
                ...
                loss_total=loss_label
        if loss_total is not None:
            return y_pred, logits, loss_total, outputs.attentions
        else:
            return y_pred, logits, outputs.attentions